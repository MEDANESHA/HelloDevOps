    ...
    stages {
        ...
        stage('Update K8s Manifest') {
            steps {
                ...
                sh "sed -i 's|spec.containers(name==hello-world-1).image.*|spec.containers(name==hello-world-1).image mycontainerregistryteldahtest.azurecr.io/helloworld:${env.BUILD_NUMBER}|' deployment.yaml"
